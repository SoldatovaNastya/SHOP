        ...
        <div className="basket-item">
            ...
            <div className='d-flex flex-row justify-content-between align-self-center'>
                ...
                <div className='d-flex flex-row align-self-center'>
                    <button className='btn btn-warning' onClick={() => decQuantity(item.offerId)}>-</button>
                    <div className='Col'><nobr> Количество: {quantity} </nobr></div>
                    <button className='btn btn-warning' onClick={() => incQuantity(item.offerId)}>+</button>
                </div>
                <button className='btn btn-warning' onClick={() => removeFromBasket(item.offerId)}>Удалить</button>
            </div>
        </div>
    );
}
